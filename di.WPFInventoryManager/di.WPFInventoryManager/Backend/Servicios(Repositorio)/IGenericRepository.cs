...
namespace di.WPFInventoryManager.Backend.Servicios
{
    /// <summary>
    ...
    public interface IGenericRepository<T> where T : class
    {
        ...
        Task<T?> FirstOrDefaultAsync(Expression<Func<T, bool>> predicate, bool asNoTracking = true, params Expression<Func<T, object>>[] includes);
        ...
        Task<List<T>> FindAsync(Expression<Func<T, bool>> predicate, bool asNoTracking = true, params Expression<Func<T, object>>[] includes);
