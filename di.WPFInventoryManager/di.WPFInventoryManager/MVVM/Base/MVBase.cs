...
namespace di.WPFInventoryManager.Frontend.MVVM.Base
{
    public class MVBase : ValidatableViewModel
    {
        ...
        //mensaje que aparece y desaparece al ratito
        ...
        /// //Chequea todos los objetos del dialogo, cuando le da al boton aceptar, es cuando comprueba que esta 
        /// todo valido
        ...
        /// Manejador de eventos, cada vez que el framework detecte un error los va sumando, si 
        /// se van solucionando, se van restando
